...
public class ButtonActionManager : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        var editMapButton = root.Q<Button>("EditMapButton");
        ...
        editMapButton?.RegisterCallback<ClickEvent>(ev => LoadMainScene(editMapScene));
    ...
    private void LoadMainScene(string sceneName)
    {
